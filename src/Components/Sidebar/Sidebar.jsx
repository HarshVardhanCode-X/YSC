...
export default function Sidebar() {
  ...
  return (
    <div className="flex text-[15px] h-screen overflow-y-scroll scrollbar-hide">
      <div className={`${isCollapsed ? "w-20" : "w-64"} bg-[#f7f7f7]  transition-all duration-300 flex flex-col`}>
          ...
          <div className="p-4">
            <ul className="space-y-2 cursor-pointer">
              ...
              <li
                ...
                className="flex items-center p-2 rounded-md text-red-500 hover:bg-gray-200">
