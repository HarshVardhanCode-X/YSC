...
const getHeaders = () => {
    const token = getLocalData(USER_DATA)?.token;
    return {
...
export const get = (query) => {
    ...
    return axios
        .get(API_BASE_URL + query, { headers })
        .then(handleResponse)
        .catch(handleError);
};
...
export const post = (query, body) => {
    ...
    return axios
        .post(API_BASE_URL + query, body, { headers })
        .then(handleResponse)
        .catch(handleError);
};
...
export const patch = (query, body) => {
    ...
    return axios
        .patch(API_BASE_URL + query, body, { headers })
        .then(handleResponse)
        .catch(handleError);
};
...
export const del = (query) => {
    ...
    return axios
        .delete(API_BASE_URL + query, { headers })
        .then(handleResponse)
        .catch(handleError);
};
